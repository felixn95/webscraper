...
import json
from decathlon_scraper.StoreStockDTO import StoreStockInfo
    ...
    def fetch_page(self, url, max_retries=3):
        ...
        while retries < max_retries:
            ...
            try:
                ...
                # log
                logger.warning(f"Failed to fetch page (retry {retries+1}/{max_retries}): {e}")
                retries += 1
    ...
    def fetch_stock_info(self, sku_id, model_id, store_id, max_retries=3):
        ...
        while retries < max_retries:
            ...
            try:
                ...
                logger.error(f"Failed to fetch stock info (retry {retries+1}/{max_retries}): {e}")
                print(headers)
            retries += 1
